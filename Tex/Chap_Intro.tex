...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene1_auto_drive_car_s.png}
        \caption{自动驾驶汽车}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene2_delivery_robot_s.png}
        \caption{配送机器人}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene3_drone_s.png}
        \caption{无人机室内导航}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene4_AR_VR_s.png}
        \caption{增强/虚拟现实设备}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene5_industrial_mobile_robot_s.png}
        \caption{仓储搬运机器人}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene6_security_patrol_robot_s.png}
        \caption{安防巡检机器人}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene7_humanoid_service_robot_s.png}
        \caption{家庭服务机器人}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/scene8_lunar_rover_s.png}
        \caption{空间探测月球车}
...
在 VIO 算法系统与硬件加速的结合方面，香港中文大学沈劭劼团队提出的 VINS-Mono 算法~\cite{qin2018vins}已成为学术界与工业界广泛采用的开源基准，为后续大量的算法改进与硬件加速工作提供了标准化的算法框架与评测基准。
