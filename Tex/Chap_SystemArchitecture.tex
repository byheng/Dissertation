...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Img/hw_sw_partition.png}
...
本系统采用 SVO 2.0~\cite{forster2016svo} 作为视觉前端，实现快速鲁棒的特征提取与帧间追踪。SVO 2.0 是一种半直接单目视觉里程计（Semi-Direct Monocular Visual Odometry），结合了直接法的快速性与特征法的鲁棒性。其核心工作流程包括以下几个关键步骤：
