...
\begin{scope}[shift={(0,0)}]
    \node[font=\large\bfseries] at (1.5, 4.2) {Bundle Adjustment};
...
\begin{scope}[shift={(7.5,0)}]
    \node[font=\large\bfseries] at (1.5, 4.2) {Reprojection Error};
    ...
    % 修正后的标签位置 (使用引线指向误差)
    \draw[-{Stealth[length=2mm]}, thin, gray] ($(p_meas)!0.5!(p_reproj)$ |- p_meas) -- (3.4, 0.5)
        node[right, black, font=\small] {$e = \|p - \hat{p}\|$};

    % 重投影曲线 (调大弧度避开文字)
    \draw[orange, ultra thick, -{Stealth[length=2mm]}] (p_obs1) to[out=45, in=135]
